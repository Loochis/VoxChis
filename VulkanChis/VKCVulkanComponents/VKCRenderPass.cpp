...
namespace VKChis {
    VKCRenderPass::VKCRenderPass(uint32_t in_flags, shared_ptr<VKCDevice> &in_device, shared_ptr<VKCSwapChain> &in_swapChain, VkResult &result)
    :flags(in_flags),
    device(in_device),
    swapChain(in_swapChain)
    {

        // Color attachement definition
        VkAttachmentDescription colorAttachment{};
        colorAttachment.format = swapChain->format_swapChainImage;
        ...
        // Depth attachment definition
        VkAttachmentDescription depthAttachment{};
        depthAttachment.format = swapChain->format_depth;
